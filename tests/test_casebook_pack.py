"""Regression checks for the beacon-rel-budget-dock casebook."""
...
from casebook.harness import assert_expected, beacon_rel_budget_dock_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(beacon_rel_budget_dock_summary(), assert_expected())
