...
- `baseline`: `budget pressure`, score 197, lane `ship`
- `stress`: `failure width`, score 228, lane `ship`
- `edge`: `recovery gap`, score 135, lane `watch`
- `recovery`: `runbook drift`, score 131, lane `watch`
- `stale`: `budget pressure`, score 198, lane `ship`
